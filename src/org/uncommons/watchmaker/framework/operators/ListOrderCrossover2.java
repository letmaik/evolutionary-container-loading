 ...
 * @author Daniel Dyer
 */
public class ListOrderCrossover2<T> extends AbstractCrossover<List<T>>
{
    /**
     * Creates a cross-over operator with a cross-over probability of 1.
     */
    public ListOrderCrossover2()
    {
     ...
     * for any given pair.
     */
    public ListOrderCrossover2(Probability crossoverProbability)
    {
     ...
     */
    public ListOrderCrossover2(NumberGenerator<Probability> crossoverProbabilityVariable)
    {
                                 ...
                                 Random rng)
    {
        ...
        // Change by neo
        int point1 = 0; //rng.nextInt(parent1.size());
