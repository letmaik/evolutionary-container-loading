...
* @author Daniel Dyer
*/
public class RankSelectionWithType<T> implements SelectionStrategy<T>
{
 private final SelectionStrategy<T> delegate;
  ...
  * to expected values.
  */
 public RankSelectionWithType()
 {
     this((SelectionStrategy<T>) new StochasticUniversalSampling());
 }
  ...
  */
 public RankSelectionWithType(SelectionStrategy<T> delegate)
 {
