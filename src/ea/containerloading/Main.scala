...
//		// thpack8 - 7
//		val problem = new ContainerProblem(
//			containerSize = Dimension3D(2400, 1300, 3500),
//			boxSizeFrequencies =
//				Map(Dimension3D(375,250,400) -> (34, BoxConstraints(widthVertical = false, depthVertical = false)),
//			        Dimension3D(275,225,400) -> (37, BoxConstraints(widthVertical = false, depthVertical = false)),
//			        Dimension3D(250,125,300) -> (23, BoxConstraints(widthVertical = false, depthVertical = false)),
...
//		// thpack8 - 12
//		val problem = new ContainerProblem(
//			containerSize = Dimension3D(2400, 1000, 3200),
//			boxSizeFrequencies =
//				Map(Dimension3D(275,200,900) -> (10, BoxConstraints(widthVertical = false, depthVertical = false)),
//			        Dimension3D(350,275,400) -> (33, BoxConstraints(widthVertical = false, depthVertical = false)),
//			        Dimension3D(300,250,1200)-> (10, BoxConstraints(widthVertical = false, depthVertical = false)),
//			        Dimension3D(375,275,500) -> (27, BoxConstraints(widthVertical = false, depthVertical = false)),
//			        Dimension3D(400,200,800) -> (15, BoxConstraints(widthVertical = false, depthVertical = false)),
//			        Dimension3D(300,225,600) -> (25, BoxConstraints(widthVertical = false, depthVertical = false))
//			        ))
		...
		val runner = new EvolutionaryContainerLoading(
			...
			//new TargetFitness(0.846, true),
			//new GenerationCount(60),
			userAbort,
			new ElapsedTime(30*60*1000)
			)
